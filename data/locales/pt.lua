locale = {
  name = "pt",
  charset = "cp1252",
  languageName = "Portuguãs",

  -- As traduçõs devem vir sempre em ordem alfabética.
  translation = {
    ...
    ["Anonymous"] = "Anônimo",
    ["Any"] = "Qualquer",
    ["Are you sure you want to logout?"] = "Vocé tem certeza que quer sair?",
    ["Attack"] = "Atacar",
    ["Audio"] = "áudio",
    ["Author"] = "Autor",
    ...
    ["Report"] = "Reportar",
    ["Please use this dialog to report bugs or players."] = "Relate para nós qual erro vocé encontrou no jogo. Vocé também pode reportar algum jogador por mal conduta ou uso de programas ilegais por aqui.",
    ...
    ["List of items that you're able to buy"] = "Lista de itens que vocé pode comprar",
    ["List of items that you're able to sell"] = "Lista de itens que vocé pode vender",
    ["Load"] = "Carregar",
    ["Logging out..."] = "Saindo...",
    ...
    ["Please, press the key you wish to add onto your hotkeys manager"] = "Por favor, pressione a tecla que vocé deseja\nadicionar no gerenciador de atalhos",
    ["Port"] = "Porta",
    ["Position"] = "Posição",
    ...
    ["Yes"] = "Sim",
    ["You are bleeding"] = "Vocé está sangrando",
    ["You are burning"] = "Vocé está queimando",
    ["You are cursed"] = "Vocé está amaldiçoado",
    ["You are dazzled"] = "Vocé está deslumbrado",
    ["You are dead"] = "Vocé está morto",
    ["You are dead."] = "Vocé está morto.",
    ["You are drowning"] = "Vocé está se afogando",
    ["You are drunk"] = "Vocé está bêbado",
    ["You are electrified"] = "Vocé está eletrificado",
    ["You are freezing"] = "Vocé está congelando",
    ["You are hasted"] = "Vocé está com pressa",
    ["You are hungry"] = "Vocé está faminto",
    ["You are paralysed"] = "Vocé está paralizado",
    ["You are poisoned"] = "Vocé está envenenado",
    ["You are protected by a magic shield"] = "Vocé está protegido com um escudo mágico",
    ["You are strengthened"] = "Vocé está reforçado",
    ["You are within a protection zone"] = "Vocé está dentro de uma zona de proteção",
    ["You can enter new text."] = "Vocé pode entrar com um novo texto.",
    ["You have %d%% to advance to level %d."] = "Vocé tem %d%% para avançar para o nível %d.",
    ["You have %s percent to go"] = "Vocé tem %s porcento para avançar",
    ["You have %s percent"] = "Vocé tem %s porcento",
    ["You have %s percent. You receive more experience with 40:00+ stamina (premium only)."] = "Vocé tem %s porcento. Vocé recebe mais experiência com stamina acima de 40:00 (caso vocé seja premium).",
    ["You may not logout during a fight"] = "Vocé não pode sair durante um combate",
    ["You may not logout or enter a protection zone"] = "Vocé não pode sair ou entrar em uma zona de proteção",
    ["You must enter a comment."] = "Vocé precisa entrar com um comentário",
    ["You must enter a valid server address and port."] = "Vocé precisa colocar um endereço e uma porta do servidor válidos.",
    ["You must select a character to login!"] = "Vocé deve selecionar um personagem para entrar!",
    ["You read the following, written by \n%s\n"] = "Vocé lé o seguinte, escrito por \n%s\n",
    ["You read the following, written on \n%s.\n"] = "Vocé lé o seguinte, escrito em \n%s.\n",
