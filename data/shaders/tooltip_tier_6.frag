// ============================================================
// TOOLTIP TIER 6 - RED #F44336 (Clean Rounded Borders + Godrays)
// ============================================================
uniform float u_Time;
uniform sampler2D u_Tex0;
varying vec2 v_TexCoord;

const vec3 TIER_COLOR = vec3(0.96, 0.24, 0.22);
...
void main()
{
    ...
    float pulse = sin(u_Time * 2.6) * 0.12 + 0.88;
    ...
    finalRGB += vec3(0.5, 0.2, 0.2) * sheen * pulse;
