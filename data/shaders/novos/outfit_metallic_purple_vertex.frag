...
// Purple metallic parameters
float reflectionSpeed = 0.9; // Speed of reflection movement
float reflectionIntensity = 0.05; // Intensity of reflective highlights
float armorSegmentSize = 0.14; // Size of armor segments/plates
