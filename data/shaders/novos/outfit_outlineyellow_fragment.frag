...
void main()
{
	...
	vec4 outline_colour;
	outline_colour.r = 0.8;  // Componente vermelha para amarelo
	outline_colour.g = 0.8;  // Componente verde para amarelo
	outline_colour.b = 0.0;  // Componente azul fixa em 0.0
	outline_colour.a = 0.4 + abs(0.4 - mod(u_Time, 0.8));  // Mantendo a animação da componente alfa
