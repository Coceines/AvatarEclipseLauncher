// Rarity: Epic (Purple) - 4-layer outline with glow
...
void main()
{
    ...
    // Purple color scheme for Epic
    vec3 innerColor = vec3(0.9, 0.4, 1.0);   // Bright purple (inner)
    vec3 midColor = vec3(0.7, 0.2, 0.85);    // Medium purple (middle)
    vec3 outerColor = vec3(0.5, 0.1, 0.65);  // Darker purple (outer)
    vec3 glowColor = vec3(1.0, 0.6, 1.0);    // Very bright pink-purple (glow)
