// Rarity: Legendary (Orange) - 4-layer outline with glow
...
void main()
{
    ...
    // Orange color scheme for Legendary
    vec3 innerColor = vec3(1.0, 0.7, 0.2);   // Bright orange (inner)
    vec3 midColor = vec3(0.9, 0.5, 0.1);     // Medium orange (middle)
    vec3 outerColor = vec3(0.7, 0.35, 0.0);  // Darker orange (outer)
    vec3 glowColor = vec3(1.0, 0.85, 0.4);   // Very bright yellow-orange (glow)
