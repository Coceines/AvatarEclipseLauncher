...
void main()
{
    ...
    // Fade to black while clouds keep moving (recreate shader so u_Time starts at 0).
    float fade = clamp(u_Time / FADE_SECONDS, 0.0, 1.0);
    finalColor.rgb = mix(finalColor.rgb, vec3(0.0), fade);
