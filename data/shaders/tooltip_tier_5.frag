// ============================================================
// TOOLTIP TIER 5 - ORANGE #FF9800 (Clean Rounded Borders + Godrays)
// ============================================================
uniform float u_Time;
uniform sampler2D u_Tex0;
varying vec2 v_TexCoord;

const vec3 TIER_COLOR = vec3(0.98, 0.60, 0.08);
...
void main()
{
    ...
    float pulse = sin(u_Time * 2.5) * 0.11 + 0.89;
    ...
    finalRGB += vec3(0.5, 0.35, 0.1) * sheen * pulse;
