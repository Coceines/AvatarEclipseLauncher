// ============================================================
// TOOLTIP TIER 2 - GREEN #4CAF50 (Clean Rounded Borders + Godrays)
// ============================================================
uniform float u_Time;
uniform sampler2D u_Tex0;
varying vec2 v_TexCoord;

const vec3 TIER_COLOR = vec3(0.28, 0.82, 0.38);
...
void main()
{
    ...
    float pulse = sin(u_Time * 2.3) * 0.11 + 0.89;
    float sheen = pow(sin(angle * 3.0 + u_Time * 1.9) * 0.5 + 0.5, 4.0) * borderLine;

    vec3 glow = TIER_COLOR * (borderLine * 1.25 + innerGlow * 0.32 + godrays * 0.68 + sheen * 0.55) * pulse;
    vec3 finalRGB = baseDark + glow;
    finalRGB += vec3(0.3, 0.5, 0.3) * sheen * pulse;
