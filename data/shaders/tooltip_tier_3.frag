// ============================================================
// TOOLTIP TIER 3 - BLUE #2196F3 (Clean Rounded Borders + Godrays)
// ============================================================
uniform float u_Time;
uniform sampler2D u_Tex0;
varying vec2 v_TexCoord;

const vec3 TIER_COLOR = vec3(0.15, 0.58, 0.98);
...
void main()
{
    ...
    float pulse = sin(u_Time * 2.4) * 0.11 + 0.89;
    ...
    finalRGB += vec3(0.2, 0.4, 0.6) * sheen * pulse;
