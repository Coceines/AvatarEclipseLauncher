locale = {
  ...
  translation = {
    ["For some reason you are unable to log in,\ncheck your internet connection and make sure the\nserver is online. If the server is online and your\ninternet connection is normal, we suggest\nre-downloading the client to remedy the problem."] = "Por algum motivo voc? n?o est? conseguindo entrar\nno servidor, verifique sua conex?o com a internet e\ncertifique-se de que o servidor est? online. Caso o\nservidor esteja online e sua conex?o com a internet esteja\nnormal, sugerimos refazer o download do client\npara sanar o problema.",
    ...
    ["Alas! Brave adventurer, you have met a sad fate.\nBut do not despair, for the gods will bring you back\ninto this world in exchange for a small sacrifice\n\nSimply click on Ok to resume your journeys!"] = "Aventureiro corajoso, voc? encontrou um destino\ntriste. Mas n?o se desespere, pois os deuses o\ntrar?o de volta neste mundo em troca de um\npequeno sacrif?cio.\n\nBasta clicar em 'Ok' para retomar suas viagens!",
    ...
    ["Report"] = "Reportar",
    ["Please use this dialog to report bugs or players."] = "Relate para n?s qual erro voc? encontrou no jogo. Voc? tamb?m pode reportar algum jogador por mal conduta ou uso de programas ilegais por aqui.",
    ...
    ["Knockout Log"] = "Knockout Log",
    ["Server"] = "Servidor",
    ["Set Outfit"] = "Escolher Roupa",
    ["Pet"] = "Pet",
    ["Select Pet"] = "Escolher Pet",
    ["No Pet"] = "Sem Pet",
    ["Remove Pet"] = "Remover Pet",
    ["You do not own any pet"] = "Voc\195\170 n\195\163o possui nenhum pet",
    ["Buy one in the Store (Pets)."] = "Compre um na Loja (categoria Pets).",
    ["Shielding"] = "Defesa",
    ...
    ["You can enter new text."] = "Voc? pode escrever um novo texto.",
	...
	["You have %s percent. You receive more experience with 40:00+ stamina."] = "Voc? tem %s porcento. Voc? recebe um pouco mais de experi?ncia com stamina acima de 40:00.", 
    ...
    ["You need to relog to update your element emblem."] = "Voc? precisa relogar para atualizar o seu emblema.",
	...
	["With inactive PvP you can not attack nor be attacked by other players. \n You also lose your 30% bonus experience."] = "Com PvP inativo voc? n?o poder? atacar e nem ser atacado por outros jogadores. \n Voc? tamb?m perder? seus 30% de experi?ncia b?nus (concedido pelo ativo)",
	["With active PvP you can attack and be attacked by other players. \n You will also receive 30% bonus experience by defeating monsters."] = "Com PvP ativo voc? poder? atacar e ser atacado por outros jogadores. \n Voc? tamb?m receber? 30% de experi?ncia b?nus derrotando monstros.",
	["Active"] = "Ativo",
	["Inactive"] = "Inativo",
	["With inactive PvP you can not attack nor be attacked by other players."] = "Com PvP inativo voc? n?o poder? atacar e nem ser atacado por outros jogadores.",
	["You also lose your 30% bonus experience."] = "Voc? tamb?m perder? sua experi?ncia b?nus (concedido pelo ativo).",
	["With active PvP you can attack and be attacked by other players."] = "Com PvP ativo voc? poder? atacar e ser atacado por outros jogadores.",
	["You will also receive 30% bonus experience by defeating monsters."] = "Voc? tamb?m receber? experi?ncia b?nus derrotando monstros.",
	["Total price:"] = "Pre?o total:",
	["Transaction ID:"] = "ID da Transa??o:",
	["Bend List"] = "Dobras",
	["Quick Looting"] = "Loot autom?tico",
	["Bend List (Ctrl F)"] = "Dobras (Ctrl+F)",
    ["Shrink game window"] = "Encolher janela do jogo (necess?rio relogar)",
    ["Stats"] = "Status",
