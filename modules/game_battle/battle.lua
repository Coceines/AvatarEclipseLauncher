...
function init()  
  ...
  battleButton = modules.client_topmenu.addRightGameToggleButton('battleButton', tr('Battle'), '/images/topbuttons/battle', toggle)
...
function doCreatureFitFilters(creature)
  ...
  -- Avatar custom: pet fantasma (criatura puramente visual) nunca entra na
  -- battle list.
  if creature:isPet() then
    return false
  end
